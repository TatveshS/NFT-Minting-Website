...
const roboPunksNFTAddress = "0xBA4687c5D8eb7CA58De8D5831eF24b663bDDb190"
...
const MainMint = ( {accounts , setAccounts}) => {
    ...
    return(
        ...
        <Box width='520px'>
            <div>
        <Text fontsize='40px' textShadow='0 5px #000000'>RoboPunks</Text>
        <Text
            fontsize='30px'
            letterSpacing='-5.55'
            fontfamily='VT323'
        ...
        </div>
        {
            ...
            (
                <p>You are not connected yet, you must be connected to Mint.</p>
            )
        }
        </Box>
        </Flex>
